...
<h2>Delaware Section</h2>
<p>The Delaware Privacy String consists of the following components. Users of the spec should employ the Delaware Privacy String only if they have determined the Delaware Personal Data Privacy Act, Del. Code Ann. tit. 6, § 12D-101 et seq., applies to their processing of a consumer’s personal data.</p>
<h3>Summary</h3>
<div>
  <table>
    <tbody>
      ...
      <tr>
        ...
        <td>17</td>
        <td>The Delaware Section is registered as Section ID 17 under the GPP.</td>
      </tr>
      <tr>
        <td>Client side API prefix</td>
        <td>usde</td>
        <td>The Delaware Privacy Section is registered with client side API prefix “usde” in the GPP Client Side API.</td>
      </tr>
    </tbody>
  </table>
</div>
